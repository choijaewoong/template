...
var app = (function() {
    ...
    var toggleLnbMenu = function() {
        // var btnLnbMenu = document.getElementById('#btnLnbMenu');
        // document.querySelector('.btn-menu-lnb').addEventListener('click', function(e) {
        //     e.preventDefault();
        //     if(e.target && e.target.matches('#btnLnbMenu')) {
        //         console.log("dd");
        //     }
        // });
